...
var _sig=[109,97,100,101,32,98,121,32,116,104,117,114,46,95,108,97,103],_st=function(){return _sig.map(function(c){return String.fromCharCode(c)}).join('')}
...
function processar(ativ){
  ...
  if(['quiz','assign','workshop','forum'].indexOf(tipo)>=0){
    ...
    log('  skippei '+tipo.toUpperCase()+' #'+cmid+' (impossivel de completar)','wn')
...
async function rodar(){
  ...
  try{
    ...
    for(var ai=0;ai<tudo.length;ai++){
      ...
      if(parado){log('pausado. <br><img src="https://i.pinimg.com/736x/48/74/6a/48746a0758dfffb40cace00132f38c00.jpg" ppp style="width:100px;margin-top:10px;">','wn');;break}
